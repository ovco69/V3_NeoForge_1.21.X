...
public class ModDataMapProvider extends DataMapProvider {
    ...
    protected void gather(HolderLookup.Provider provider) {
        ...
        this.builder(NeoForgeDataMaps.COMPOSTABLES)
                .add(ModItems.RADISH_SEEDS.getId(), new Compostable(.25f), false)
                .add(ModItems.RADISH.getId(), new Compostable(.45f), false)
                .add(ModItems.GOJI_BERRIES.getId(), new Compostable(.3f), false);
    }
}
