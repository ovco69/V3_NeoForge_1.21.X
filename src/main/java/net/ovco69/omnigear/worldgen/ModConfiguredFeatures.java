...
public class ModConfiguredFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, NETHER_BISMUTH_ORE_KEY, Feature.ORE, new OreConfiguration(
                netherrackReplaceables,
                ModBlocks.NETHER_BISMUTH_ORE.get().defaultBlockState(),
                9)
        );
        register(context, END_BISMUTH_ORE_KEY, Feature.ORE, new OreConfiguration(
                endStoneReplaceables,
                ModBlocks.END_BISMUTH_ORE.get().defaultBlockState(),
                9)
        );
        ...
        register(context, GOJI_BERRY_BUSH_KEY, Feature.RANDOM_PATCH,
                FeatureUtils.simplePatchConfiguration(
                        ...
                        new SimpleBlockConfiguration(
                                BlockStateProvider.simple(ModBlocks.GOJI_BERRY_BUSH.get().defaultBlockState().setValue(GojiBerryBushBlock.AGE, 3))
                        ),
    ...
    public static ResourceKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, ResourceLocation.fromNamespaceAndPath(OmniGear.MOD_ID, name));
    }
