...
public class ModPlacedFeatures {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        register(
                ...
                ModOrePlacement.commonOrePlacement(12, HeightRangePlacement.triangle(
    ...
    private static ResourceKey<PlacedFeature> registerKey(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.fromNamespaceAndPath(OmniGear.MOD_ID, name));
    }
