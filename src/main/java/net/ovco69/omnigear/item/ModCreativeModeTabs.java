...
public class ModCreativeModeTabs {
    public static final DeferredRegister<CreativeModeTab> TABS = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, OmniGear.MOD_ID);

    public static Supplier<CreativeModeTab> TUTORIAL_ITEMS = TABS.register("tutorial_items_tab",
            () -> CreativeModeTab.builder()
                    .icon(() -> new ItemStack(ModItems.BISMUTH.get()))
                    .title(Component.translatable("creativetab." + OmniGear.MOD_ID + ".tutorial_items"))
                    .displayItems((itemDisplayParameters, output) -> {
                        ...
                        output.accept(ModItems.SCYTHE_OF_SHADOWS);
                    })
                    .build());

    public static Supplier<CreativeModeTab> TUTORIAL_BLOCKS = TABS.register("tutorial_blocks_tab",
            () -> CreativeModeTab.builder()
                    .withTabsBefore(ResourceLocation.fromNamespaceAndPath(OmniGear.MOD_ID, "tutorial_items_tab"))
                    .icon(() -> new ItemStack(ModBlocks.BISMUTH_BLOCK.get()))
                    .title(Component.translatable("creativetab." + OmniGear.MOD_ID + ".tutorial_blocks"))
                    .displayItems((itemDisplayParameters, output) -> {
