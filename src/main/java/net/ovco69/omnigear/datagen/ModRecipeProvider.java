...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(RecipeOutput recipeOutput) {
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.BISMUTH.get(), 9)
                ...
                .save(recipeOutput, OmniGear.MOD_ID + ":bismuth_from_magic_block");
        ...
        trimSmithing(recipeOutput, ModItems.OVCO_SMITHING_TEMPLATE.get(), ResourceLocation.fromNamespaceAndPath(OmniGear.MOD_ID, "ovco"));
    ...
    protected static <T extends AbstractCookingRecipe> void oreCooking(RecipeOutput recipeOutput, RecipeSerializer<T> pCookingSerializer,
        ...
        for (ItemLike itemLike : pIngredients) {
            SimpleCookingRecipeBuilder.generic(Ingredient.of(itemLike), pCategory, pResult, pExperience, pCookingTime, pCookingSerializer, factory)
                    ...
                    .save(recipeOutput, OmniGear.MOD_ID + ":" + getItemName(pResult) + pRecipeName + "_" + getItemName(itemLike));
        }
    }
}
