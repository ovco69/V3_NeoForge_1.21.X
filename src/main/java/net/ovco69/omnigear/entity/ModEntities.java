package net.ovco69.omnigear.entity;
...
import net.ovco69.omnigear.entity.custom.ChairEntity;
...
public class ModEntities {
    public static final DeferredRegister<EntityType<?>> ENTITY_TYPES = DeferredRegister.create(BuiltInRegistries.ENTITY_TYPE, OmniGear.MOD_ID);
